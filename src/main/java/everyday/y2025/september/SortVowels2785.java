...
public class SortVowels2785 {
    ...
    public static void main(String[] args) {
        String s = new SortVowels2785().sortVowels("lEetcOde");
    ...
    public String sortVowels(String s) {
        ...
        characters.stream().sorted().forEach(a -> {
            while (chars[startIndex[0]] != 0 && startIndex[0] < s.length() - 1) {
                startIndex[0]++;
            }
            chars[startIndex[0]++] = a;
        });
