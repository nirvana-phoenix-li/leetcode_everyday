 ...
 * 通过次数15,241提交次数33,721
 */
public class MinNumberOfHours2383 {

    public static void main(String[] args) {
        MinNumberOfHours2383 main = new MinNumberOfHours2383();
//        1
//        1
//                [1,1,1,1]
//[1,1,1,50]
...
//        int[] experience = {1,1,1,50};
        ...
        int i = main.minNumberOfHours(5, 3, energy, experience);
    ...
    public int minNumberOfHours(int initialEnergy, int initialExperience, int[] energy, int[] experience) {
        ...
        if (initialEnergy <= 0) {
            allTime = allTime + 1 - initialEnergy;
        }
        return allTime;
    }
}
